<x-dialog-modal wire:model="isOpen">
    <x-slot name="title">
        <h3>Registrar Estado de pago</h3>
    </x-slot>
    <x-slot name="content">
        ...
        <div class="flex justify-between mx-2 mb-6">
            <div class="mb-2 md:mr-2 md:mb-0 w-full">
                ...
                <x-input wire:model="payment_status_form.estado" id="nombre" type="text" class="w-full" />
                <x-input-error for="payment_status_form.estado" />
            </div>
        </div>
